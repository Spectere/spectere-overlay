...
SRC_URI="https://github.com/dbeaver/dbeaver/releases/download/${PV}/dbeaver-ce-${PV}-linux.gtk.x86.tar.gz
	amd64? ( https://github.com/dbeaver/dbeaver/releases/download/${PV}/dbeaver-ce-${PV}-linux.gtk.x86_64.tar.gz )"
